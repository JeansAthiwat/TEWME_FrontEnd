...
const Navbar = ({ accountState, onLogout, profilePicture }) => {
  ...
  const navObjects = [
    ...
    { id: 2, name: "My Courses", path: "mycourse", permission: "tutor" },
    { id: 3, name: "Verify Tutors", path: "admin", permission: "admin" },
    { id: 4, name: "Chat Box", path: "chatbox", permission: "all" },
    { id: 5, name: "Notifications", path: "notification", permission: "all" },
    // New nav item for image upload:
    { id: 6, name: "Upload", path: "upload", permission: "all" }
  ];
    ...
    <>
      <div className='navbar'>
        ...
        <div className="nav-login-profile">
          ...
          {accountState !== "unregistered" && <Link to='/myprofile'><img src={profilePicture} alt="Profile" /></Link>}
        </div>
      </div>
